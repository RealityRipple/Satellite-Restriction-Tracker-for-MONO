...
namespace RestrictionTrackerGTK
{
    ...
    Gtk.Window
  {
      ...
      base(Gtk.WindowType.Toplevel)
    {
      ...
      lblVersion.Markup = "<a href=\"http://srt.realityripple.com/For_MONO/changes.php\">Version " + modFunctions.DisplayVersion(modFunctions.ProductVersion) + "</a> on " + RestrictionLibrary.srlFunctions.CLRCleanVersion;
