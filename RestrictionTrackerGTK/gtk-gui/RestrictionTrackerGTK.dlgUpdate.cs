	...
	public partial class dlgUpdate
	{
		...
		protected virtual void Build()
		{
			...
			this.lblNewVer.LabelProp = global::Mono.Unix.Catalog.GetString("<span size=\"9000\">Version %v has been released and is available for download.\nTo " +
					"keep up-to-date with the latest features, improvements, bug fixes, and\nmeter com" +
					"pliance, please update %p immediately.</span>");
			...
			this.lblBETA.LabelProp = global::Mono.Unix.Catalog.GetString("<span color=\"Firebrick\">BETA updates may have bugs and other issues that haven\'t " +
					"been\nworked out yet, but need testing on a wide range of accounts.\nPlease back u" +
					"p your history before using BETAs.</span>");
